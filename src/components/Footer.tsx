...
export const Footer = () => {
  ...
  return <footer className="bg-[#1E3A8A] text-white py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="mb-4 text-gray-300">
              Offering high-quality alkaline water machines to improve health and well-being.
            </p>
            <WhatsappButton text="Contact Us" />
            <div className="mt-4 flex space-x-4">
              <a href="https://www.facebook.com/share/p/16ecnYZm6U/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#A2CBFF] transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                  <path d="M9.19795 21.5H13.198V13.4901H16.8021L17.198 9.50977H13.198V7.5C13.198 6.94772 13.6457 6.5 14.198 6.5H17.198V2.5H14.198C11.4365 2.5 9.19795 4.73858 9.19795 7.5V9.50977H7.19795L6.80206 13.4901H9.19795V21.5Z" />
                </svg>
              </a>
              <a href="https://www.youtube.com/channel/UC1KoXurgPF4D_37muZxfj0w" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#A2CBFF] transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
