        ...
        <AnimatedSection animation="fade-up" delay={800}>
          <div className="mt-20 text-center">
            ...
            <p className="text-lg text-blue-100 max-w-2xl mx-auto mb-8">
              Our alkaline water machines have helped 
              thousands of people feel better and be healthier.
            </p>
            {/* Highlighted call-to-action */}
            <div className="inline-block relative mb-10">
              <div className="absolute -inset-1 bg-[#1E3A8A] rounded-full blur opacity-70"></div>
              <div className="relative bg-white rounded-full p-1">
                <div className="flex flex-col sm:flex-row justify-center gap-4 p-2">
                ...
                }} className="bg-[#1E3A8A] hover:bg-[#152a66] text-white font-medium py-3 px-8 rounded-full transition-all transform hover:scale-105 text-lg flex items-center justify-center">
                  ...
                  <a href="https://waterfilterguru.com/what-is-an-alkaline-water-filter/" target="_blank" rel="noopener noreferrer" className="bg-[#A2CBFF] hover:bg-[#8bb8f0] text-[#1E3A8A] font-medium py-3 px-8 rounded-full transition-all transform hover:scale-105 text-lg">
                    Learn More
                  </a>
                </div>
              </div>
