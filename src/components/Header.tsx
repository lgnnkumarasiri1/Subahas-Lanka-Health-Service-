  ...
  return <header className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white shadow-md py-2' : 'bg-transparent py-4'}`}>
      <div className="container mx-auto px-4 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <div className={`relative ${isScrolled ? 'scale-90' : ''} transition-transform duration-300`}>
            {isScrolled && <div className="absolute -inset-1 bg-gradient-to-r from-[#1E3A8A]/20 to-[#A2CBFF]/30 rounded-full blur-sm"></div>}
            <img src="/subahas_health.png" alt="Subahas Lanka Health & Engineering Service Logo" className="h-14 w-auto relative" />
          </div>
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <a href="#home" className="text-[#1E3A8A] hover:text-[#A2CBFF] font-medium transition-colors">
            Home
          </a>
          <a href="#history" className="text-[#1E3A8A] hover:text-[#A2CBFF] font-medium transition-colors">
            Water History
          </a>
          <a href="#doctors" className="text-[#1E3A8A] hover:text-[#A2CBFF] font-medium transition-colors">
            Expert Opinions
          </a>
          <a href="#testimonials" className="text-[#1E3A8A] hover:text-[#A2CBFF] font-medium transition-colors">
            Educational Videos
          </a>
